...
class ModuleHelper(object):
    ...
    def BNReLU(num_features, bn_type=None, **kwargs):
        if bn_type == 'torchbn':
            ...
            from geoseg.extensions.syncbn.module import BatchNorm2d
            return nn.Sequential(
                BatchNorm2d(num_features, **kwargs),
                nn.ReLU()
            )
        elif bn_type == 'sn':
            from geoseg.extensions.switchablenorms.switchable_norm import SwitchNorm2d
            return nn.Sequential(
            ...
            if torch_ver == '0.4':
                from geoseg.extensions.inplace_abn.bn import InPlaceABNSync
                return InPlaceABNSync(num_features, **kwargs)
            elif torch_ver in ('1.0', '1.1'):
                from geoseg.extensions.inplace_abn_1.bn import InPlaceABNSync
                return InPlaceABNSync(num_features, **kwargs)
            elif torch_ver == '1.2':
