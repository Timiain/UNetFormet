...
from geoseg.models.backbones.backbone_selector import BackboneSelector
from geoseg.models.tools.module_helper import ModuleHelper
from geoseg.models.modules.projection import ProjectionHead
from geoseg.utils.tools.logger import Logger as Log
from geoseg.models.modules.hanet_attention import HANet_Conv
from geoseg.models.modules.contrast import momentum_update, l2_normalize, ProjectionHead
from geoseg.models.modules.sinkhorn import distributed_sinkhorn
...
class HRNet_W48_Proto(nn.Module):
    ...
    def forward(self, x_, gt_semantic_seg=None, pretrain_prototype=False):
        ...
        if pretrain_prototype is False and self.use_prototype is True and gt_semantic_seg is not None:
            ...
            #out_seg should reverse for check 
            out_seg=F.interpolate(out_seg, size=(o_h, o_w), mode="bilinear", align_corners=True)
...
class HRNet_W48_OCR_CONTRAST(nn.Module):
    def __init__(self, configer):
        ...
        from geoseg.models.modules.spatial_ocr_block import SpatialGather_Module
        self.ocr_gather_head = SpatialGather_Module(self.num_classes)
        from geoseg.models.modules.spatial_ocr_block import SpatialOCR_Module
