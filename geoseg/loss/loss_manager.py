...
from geoseg.loss.loss_helper import FSAuxOhemCELoss, FSOhemCELoss, FSRMILoss
from geoseg.loss.loss_helper import FSCELoss, FSAuxCELoss, FSAuxRMILoss, FSCELOVASZLoss, MSFSAuxRMILoss, FSAuxCELossDSN
from geoseg.loss.loss_helper import SegFixLoss
from geoseg.loss.rmi_loss import RMILoss
from geoseg.loss.loss_contrast import ContrastAuxCELoss, ContrastCELoss
from geoseg.loss.loss_contrast_mem import ContrastCELoss as MemContrastCELoss
from geoseg.loss.loss_proto import PixelPrototypeCELoss

from geoseg.utils.tools.logger import Logger as Log
from geoseg.utils.distributed import is_distributed
...
class LossManager(object):
    ...
    def _parallel(self, loss):
        ...
        if self.configer.get('network', 'loss_balance') and len(self.configer.get('gpu')) > 1:
            ...
            from geoseg.extensions.parallel.data_parallel import DataParallelCriterion
